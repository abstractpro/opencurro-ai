...
const providers: ProviderId[] = ['openrouter', 'groq', 'nvidia', 'fireworks', 'ollama_cloud', 'opencode_zen', 'aihubmix', 'blueclaw', 'zenmux']
...
const PROVIDER_META: Record<ProviderId, { description: string; iconClass: string }> = {
  ...
  zenmux: { description: 'Unified gateway for 100+ AI models', iconClass: 'bg-[rgba(217,70,239,0.12)] text-[#d946ef]' },
}
